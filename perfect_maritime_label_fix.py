...
def perfect_maritime_label_fix():
    count = 0
    # Final Standardized Bottom Widget with your specific labeling
    FINAL_WIDGET_HTML = """
...
"""
    ...
    for root, dirs, files in os.walk("."):
        for file in files:
            if file == "index.html":
                ...
                # A. Purge any legacy bottom widgets or the temporary labeled one
                ...
                # B. Inject the Final Labeled Leaderboard above Footer
    ...
    print(f"Maritime Label Refinement: {count} pages brought to Elite Standard with 'Explore Global Partner Fleet' heading.")

if __name__ == "__main__":
    perfect_maritime_label_fix()
